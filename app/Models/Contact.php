...
class Contact extends Model
{
    ...
    protected $fillable = [
        'entity_id_crm',
        'dni', 'sex', 'date_of_birth', 'province_state', 'postal_code', 'street', 'locality', 'registration_number', 'area_of_work', 'training_interest'
    ];
    ...
    {
        $lead = $this->hasOne(Lead::class, 'contact_id');
        return $lead;
    }
