...
public function stepConversionContact(Request $request){
    ...
    */
    ...
    public function updateEntityIdLeadVentas(Request $request){
        $crmAttributes = $request->input("crm");
        $leadAttributes = $request->input("lead");
        $leadAttributes["entity_id_crm"] = $crmAttributes["id"];
       
        $newOrUpdatedLead = Lead::updateOrCreate(['email' => $leadAttributes["email"]], $leadAttributes);
